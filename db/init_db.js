...
let dbPath = __dirname + '/blog_db.db';
...
exports.initdb = function(){
  ...
  db.serialize(function() {
    ...
    db.run("CREATE TABLE IF NOT EXISTS blogMapTag (blogId INT, tagId INT, FOREIGN KEY(blogId) REFERENCES Blog(id), FOREIGN KEY(tagId) REFERENCES Tag(rowid))");
